...
function AddCustomer() {
    ...
    const handleAddCustomer = async()=>{
        ...
        try {
          const response = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/customers/add`,{
            firstName,
            lastName,
            email,
            phone,
  ...
  return  (
    <>
<div classNameName=' absolute top-0 left-0 right-0 bottom-0 bg-gray-300 w-full h-[100vh] flex justify-center items-center'></div>
