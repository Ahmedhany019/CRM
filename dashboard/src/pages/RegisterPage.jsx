...
function RegisterPage({setToken}) {
  ...
  return isLogin ? <LoginPage setToken={setToken} setIsLogin={setIsLogin}/>: (
        ...
        <p className="text-center text-gray-600 mt-6">
            ...
            <button className="text-indigo-800 hover:underline cursor-pointer" onClick={()=>setIsLogin(true)}>Sign In</button>
        </p>
    </div>
        </div>
  )
